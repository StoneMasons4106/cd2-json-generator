...
document.addEventListener('click', function(e) {
    ...
    if (addEncounterDifficultyButton) {
        if (removeEncounterDifficultyButton.classList.contains('hide')) {
            removeEncounterDifficultyButton.classList.remove('hide');
            removeEncounterDifficultyButton.classList.add('show');
        }
        ...
        var updatedEncounterBins = document.querySelectorAll('.encounter-difficulty-bin-row');
        if (updatedEncounterBins.length === 1) {
            removeEncounterDifficulty.classList.remove('show');
            removeEncounterDifficulty.classList.add('hide');
        }
    }
});